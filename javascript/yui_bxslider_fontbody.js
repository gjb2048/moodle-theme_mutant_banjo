...
YUI().use('jquery-bxslider', function(Y) {
    var wwwroot = $('div #mutant_banjofontbodywwwroot').attr('wwwroot');
    ...
    $('#admin-fontbody .form-description').css('margin: 1.5em 0 0 14.25em;');
    $(document).ready(function(){
        var startslide = $('div #mutant_banjofontbodywwwroot').attr('startslide');
        var width = $('div #mutant_banjofontbodywwwroot').attr('width');
        $('#fontbody-bxslider').bxSlider({
            onSlideAfter: function($slideElement, oldIndex, newIndex){
                var value = $('.mutant_banjofontbodyimage-'+parseInt(newIndex)).attr('mutant_banjofontbody');  // When slide 0 in bxslider get '01' for newIndex when using right arrow in 4.0 - check for 4.1.
                $('.mutant_banjofontbodyinput').attr('value', value);
            },
